...
def plot_cdfs(cdf_csv_files, labels, output_plot):
    ...
    plt.xticks(range(0, int(max_x) + 50, 50))
...
def main():
    cdf_csv_files = [
        ...
        '/home/beachater/Thesis/simulation/sabre-ash/sabre-ash/plotting/cdf_data/cdf_ashbolaE_data/cdf_time_average_bitrate_change.csv', 
    ...
    output_plot = '/home/beachater/Thesis/simulation/sabre-ash/sabre-ash/plotting/SD_NEWavg_bit_osc_plot.png'  # Path to save the plot
